...
// 		if(memberRepo.findMemberByAdharNumber(member.getIdCard().getIdProof().getIdNumber()) != null) {
...
//     @Override
//     public Member getMemberByAdharNo(String adharNumber) throws MemberException {
//         // TODO Auto-generated method stub
//         throw new UnsupportedOperationException("Unimplemented method 'getMemberByAdharNo'");
//     }
