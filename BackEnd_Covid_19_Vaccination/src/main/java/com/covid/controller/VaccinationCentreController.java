...
public class VaccinationCentreController{
    ...
    public List<VaccinationCentre> getVaccinationCentre(){
    ...
    @PostMapping("/vaccinationcentre")
    public VaccinationCentre addvVaccinationCentre(@RequestBody VaccinationCentre vaccinationCentre){
     //   VaccineInventory vaccineInventory = vaccinationCentreRepository.findbyCentreId(vaccinationCentre.getCentreId());
